      ...
      <div className="bg-white text-black px-4 sm:px-10 lg:px-20 py-10 mt-5">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 lg:flex-nowrap lg:gap-3">
            {/* Card 1 */}
            <div className="group flex flex-col justify-center items-center rounded-lg bg-[#F8F8F8] p-5 w-full sm:w-60 h-auto lg:h-70 shadow-sm hover:shadow-md text-lg">
              ...
              <p className="font-sans font-light text-sm text-center px-3">
